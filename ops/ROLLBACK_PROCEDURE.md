###### Start of Document \</C/dev/repos/paste-wrong-file-blocker/ops/ROLLBACK_PROCEDURE.md\>
# ROLLBACK_PROCEDURE.md
### Purpose
Defines the mandatory rollback procedure for Paste Wrong File Blocker if post‑release monitoring detects instability, regressions, or critical anomalies.
...
Paste Wrong File Blocker may only be re‑released when:
...
###### End of Document \</C/dev/repos/paste-wrong-file-blocker/ops/ROLLBACK_PROCEDURE.md\>
