###### Start of Document \</C/dev/repos/paste-wrong-file-blocker/docs/DOCTRINE_FREEZE.md\>
...
###### End of Document \</C/dev/repos/paste-wrong-file-blocker/docs/DOCTRINE_FREEZE.md\>
